...
import Modelo.WhatsAppNotifier;
...
public class VentaDao{
    ...
    public boolean ActualizarStock(int cant, String cod){
        ...
        String consulta = "SELECT nombre FROM productos WHERE codigo = ?";
        try {
            con = cn.getConnection();
            ps = con.prepareStatement(sql);
            ps.setInt(1,cant);
            ...
            ps.execute();
             ...
             // Si el stock es menor a 5, enviamos una notificación
        if (cant < 5) {
            ...
            if (rs2.next()) {
                ...
                WhatsAppNotifier.enviarMensaje(mensaje);
            }
        }
            return true;
        } catch (SQLException e) {
